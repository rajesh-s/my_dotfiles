...
function s:Add()
   ...
   w! %.emacsautotmp
   !emacs -batch -l ~/.vim/misc/verilog-mode.el %.emacsautotmp -f verilog-batch-auto
   %!cat %.emacsautotmp 
   if &expandtab
      retab
...
function s:Delete()
   ...
   " maybe add /tmp to the temporary filename
   w! %.emacsautotmp
   !emacs -batch -l ~/.vim/misc/verilog-mode.el %.emacsautotmp -f verilog-batch-delete-auto
   %!cat %.emacsautotmp 
   !rm %.emacsautotmp
endfunction
